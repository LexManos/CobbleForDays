 ...
 */
package net.minecraftforge.lex.clbl;
...
@Mod(CobbleLifeBestLife.MODID)
public class CobbleLifeBestLife {
    public static final String MODID = "cobblelifebestlife";

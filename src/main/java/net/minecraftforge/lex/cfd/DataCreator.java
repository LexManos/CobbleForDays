...
public class DataCreator {
	...
	private static class ItemModels extends ItemModelProvider {
		...
		private void makeTier(Block block) {
			...
			getBuilder(path).parent(new ModelFile.UncheckedModelFile(modLoc("block/" + path))); //TODO: Ask tterrag about this...
		}
	...
	private static class BlockStates extends BlockStateProvider {
		...
		private void makeTier(Block block, ResourceLocation texture) {
			ModelFile model = models().getBuilder(block.getRegistryName().getPath()).parent(models().getExistingFile(modLoc("block/generator"))).texture("material", texture);
